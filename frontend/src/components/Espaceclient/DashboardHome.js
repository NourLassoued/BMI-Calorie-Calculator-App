...
export default function DashboardHome() {
  ...
  const handleImageUpload = async (file) => {
    try {
      ...
      const response = await fetch(
        `http://localhost:5000/users/updateUser/${decoded.id}`,
        {
          method: "PUT",
          headers: {
  ...
  const progressionPoids =
    (userData.poidsDepart || 0) - (userData.poidsActuel || 0);
  const objectifTotal =
    (userData.poidsDepart || 0) - (userData.poidsCible || 0);
  const pourcentageProgression =
    objectifTotal > 0
      ? ((progressionPoids / objectifTotal) * 100).toFixed(1)
      : 0;
  ...
  const isPerte = progressionPoids > 0;
  ...
  const progressionIcon = isPerte ? "🔥" : progressionPoids < 0 ? "⚠️" : "⚖️";
        ...
        <div className="dashboard-content ">
            ...
            <div className="profile-content">
              <div className="profile-avatar-section">
                ...
                >
                  ...
                  {imagePreview ? (
                    ...
                    userData.image_user !== "default.jpg" ? (
                    <img
              ...
              <div className="profile-info-section">
                ...
                <div className="info-grid">
                  ...
                  />
                  <InfoCard
                    label="Compte créé depuis"
                    value={`${joursDepuisDebut} jours`}
                    icon="📅"
                  />
                </div>
              </div>
          ...
          <div className="progression-card">
            ...
            >
              ...
              <span>
                📊 Reste :{" "}
                {Math.abs(userData.poidsActuel - userData.poidsCible).toFixed(
                  1
                )}{" "}
                kg
              </span>
